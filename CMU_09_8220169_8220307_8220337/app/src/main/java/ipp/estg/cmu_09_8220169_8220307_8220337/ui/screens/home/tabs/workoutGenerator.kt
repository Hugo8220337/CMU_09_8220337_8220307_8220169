...
fun WorkoutGeneratorScreen(navController: NavController) {
    ...
    val bodyParts = listOf("back", "cardio", "chest", "lower arms", "lower legs", "neck", "shoulders", "upper arms", "upper legs", "waist")
    ...
    Column(
        ...
        Button(
            onClick = { /* Handle workout generation */ },
            modifier = Modifier
            ...
            Text("Generate Workout", color = Color.White, style = MaterialTheme.typography.bodyLarge)
        }
    }
}
